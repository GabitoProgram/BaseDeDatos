...
<h3 class="my-3" id="titulo">DOCTORES</h3>

<a href="<?= base_url('doctores/new'); ?>" class="btn btn-success">Agregar</a>
...
<table class="table table-hover table-bordered my-3" aria-describedby="titulo">
    <thead class="table-dark">
        <tr>
            ...
            <th scope="col">Horaios De Consulta</th>
    ...
    <tbody>
        <?php foreach ($doctores as $doctores) : ?>
            <tr>
                ...
                <td><?= $doctores['horariosConsulta']; ?></td>
                <td>
                    <a href="<?= base_url('doctores/'.$doctores['id_D'].'/edit'); ?>" class="btn btn-warning btn-sm me-2">Editar</a>

                    <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#eliminaModal" 
                    data-bs-url="<?= base_url('doctores/'.$doctores['id_D']); ?>">Eliminar</button>
                </td>
            </tr>
