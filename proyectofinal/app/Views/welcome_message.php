...
<!-- Agrega una clase personalizada al botón para cambiar el color -->
...
<head>
    ...
    <style>
        ...
        .navbar {
            ...
            align-items: center;
            padding: 1rem 2rem;
            background-color: #76c7c0; /* Verde azulado claro */
        }
        .navbar .logo {
            font-size: 1.5rem;
            font-weight: 600;
        ...
        .navbar ul li a:hover {
            background-color: #f39c12; /* Color del botón de editar */
            color: #fff;
        }
        .navbar ul li a::after {
            ...
            height: 2px;
            width: 0;
            background: #e74c3c; /* Color del botón de eliminar */
